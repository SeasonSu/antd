...
function (_React$Component) {
  ...
  _createClass(FormItem, [{
    ...
    value: function renderHelp(prefixCls) {
      ...
      return help ? React.createElement(_tooltip["default"], {
        ...
        overlayClassName: "".concat(prefixCls, "-errorTooltip")
      }, React.createElement(_icon["default"], {
        className: "".concat(prefixCls, "-errorIcon"),
        component: _ErrorSvg["default"]
      })) : "";
    }
  }, {
    key: "renderExtra",
    ...
    value: function renderValidateWrapper(prefixCls, c1, c2) {
    ...
    value: function renderLabel(prefixCls) {
      ...
      return React.createElement(_context["default"].Consumer, {
        ...
        }, _this3.renderHelp(prefixCls), labelChildren)) : null;
      });
    }
  }, {
    key: "renderChildren",
    value: function renderChildren(prefixCls) {
      ...
      return [this.renderLabel(prefixCls), this.renderWrapper(prefixCls, this.renderValidateWrapper(prefixCls, children, this.renderExtra(prefixCls)))];
    }
  }, {
    key: "render",
